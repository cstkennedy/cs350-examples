...
public class TestRoster {
    ...
    @Test
    public void testEnrollDuplicateStudents()
    {
        //This is where the fun starts
        Roster cs725 = new Roster(4, "CS 725");
        ...
        // Try to add the same 3 students again
        assertThat(cs725.enroll(john), is(false));
        assertThat(cs725.enroll(tom), is(false));
        assertThat(cs725.enroll(jay), is(false));
        
        assertThat(cs725.getEnrollLimit(), equalTo(4));
        assertThat(cs725.numEnrolled(), equalTo(3));
        ...
        assertThat(cs725.hashCode(), equalTo(oldHashCode));
    }
