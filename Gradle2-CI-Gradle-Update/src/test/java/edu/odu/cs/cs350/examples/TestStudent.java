...
public class TestStudent {
    ...
    {
        Student tom = (Student) student.clone();

        // Check that all values match
        assertThat(tom.getName(), is(Student.DEFAULT_NAME));
        assertThat(tom.getName(), equalTo(Student.DEFAULT_NAME));

        assertThat(tom.hashCode(),
                   equalTo((Student.DEFAULT_NAME).hashCode()));
        
        assertThat(tom.toString(), equalTo(Student.DEFAULT_NAME));

        // Check that tom and student are distinct objects (deep-copy)
        assertThat(tom, not(sameInstance(student)));

        //fail("Left as an Exercise");
    }

    /**
     * Test the Student.equals method for a non-Student
     * object
     */
    @Test
    public void testEqualsWithNotStudent()
    {
        Object notStudent = new Object();

        assertThat(student, not(equals(notStudent)));
    }
